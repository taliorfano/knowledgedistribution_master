...
date1 =  datetime.datetime(2019,1,1,0,0) # desconsidera o ano de 2019 da coleta
...
with open('coletas-bootstrap-authors-group-sem2019.csv', 'w', newline='', encoding='utf-8') as csvfile:
